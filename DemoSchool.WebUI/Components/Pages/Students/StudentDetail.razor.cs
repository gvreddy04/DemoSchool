...
public partial class StudentDetail : ComponentBase, IDisposable
{
    ...
    protected override async Task OnInitializedAsync()
    {
        try
        {
            ...
            var studentVm = await _studentApiClient.GetStudentByIdAsync(StudentId);
    ...
    private async Task StudentHandleValidSubmit()
    {
        try
        {
            ...
            var isUpdateSuccess = await _studentApiClient.UpdateStudentByOidAsync(student);
    ...
    private async Task StudentAddressHandleValidSubmit()
    {
        try
        {
            ...
            var isUpdateSuccess = await _studentApiClient.UpdateStudentAddressByOidAsync(address);
